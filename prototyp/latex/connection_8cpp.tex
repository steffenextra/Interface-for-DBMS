...
void \textbf{ connection\+\_\+query} (std\+::string sql\+Command)
...
\begin{center}
\leavevmode
\includegraphics[width=295pt]{connection_8cpp_ab12a404eefae07281e8d1273ca3fc447_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{connection_8cpp_ab12a404eefae07281e8d1273ca3fc447_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=306pt]{connection_8cpp_a05a069b8d1bef185dd0ff85424e2e13c_cgraph}
\end{center}
\end{figure}
Hier ist ein Graph der zeigt, wo diese Funktion aufgerufen wird\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{connection_8cpp_a05a069b8d1bef185dd0ff85424e2e13c_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=280pt]{connection_8cpp_af8ead42df91543eb727f4ab7e44e49d5_cgraph}
\end{center}
\end{figure}
Hier ist ein Graph der zeigt, wo diese Funktion aufgerufen wird\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{connection_8cpp_af8ead42df91543eb727f4ab7e44e49d5_icgraph}
\end{center}
\end{figure}
...
Definiert in Zeile 174 der Datei connection.\+cpp.

Hier ist ein Graph, der zeigt, was diese Funktion aufruft\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=267pt]{connection_8cpp_adda241635377573037e48ec03e645c22_cgraph}
\end{center}
\end{figure}
Hier ist ein Graph der zeigt, wo diese Funktion aufgerufen wird\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=236pt]{connection_8cpp_adda241635377573037e48ec03e645c22_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=217pt]{connection_8cpp_a960705de531a20389fb29928d43258c3_icgraph}
\end{center}
\end{figure}
...
Definiert in Zeile 10 der Datei connection.\+cpp.
...
Definiert in Zeile 4 der Datei connection.\+cpp.
...
Definiert in Zeile 8 der Datei connection.\+cpp.
...
Definiert in Zeile 6 der Datei connection.\+cpp.
