...
std\+::string \textbf{ connection\+\_\+query} (std\+::string sqlcommand)
\begin{DoxyCompactList}\small\item\em Sendet eine Abfrage zum S\+Q\+L-\/\+Server. \end{DoxyCompactList}\item 
bool \textbf{ connectionless} (const char $\ast$host, const char $\ast$user, const char $\ast$passwort, const char $\ast$db, unsigned int port, const char $\ast$unix\+\_\+socket, unsigned int client\+\_\+flag)
\item 
...
std\+::string \textbf{ show\+Databases} ()
...
std\+::string \textbf{ show\+Table} (std\+::string table\+Name)
...
std\+::string \textbf{ get\+All\+Column} (std\+::string table\+Name)
\begin{DoxyCompactList}\small\item\em Anzeigen von Spalten. \end{DoxyCompactList}\item 
std\+::string \textbf{ count\+Datasets} (std\+::string table\+Name)
\begin{DoxyCompactList}\small\item\em Zählen der Datensätze. \end{DoxyCompactList}\item 
std\+::string \textbf{ show\+Column\+Typ} (std\+::string table\+Name, std\+::string datatype)
...
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a88c581f1a3f4e5319ab41c2cc8ef67af}} 
...
void 
\end{DoxyReturn}
\mbox{\label{sqllib_8hpp_ad03c38dd32272758034b10850a948786}} 
...
Die Methode \char`\"{}connection\+\_\+feedback\char`\"{} liefert eine Spalte des aktuellen Datensatzes.~\newline
 Diese wird benutzt um einzelne Ergebnis zurückzugeben. (Bspw. \doxyref{select\+Count()}{S.}{selection_request_8cpp_aca36da6198b8c35ba721a68a51cd8898} )
...
\begin{center}
\leavevmode
\includegraphics[width=295pt]{sqllib_8hpp_ad03c38dd32272758034b10850a948786_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_ad03c38dd32272758034b10850a948786_icgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a15d37939fd8d5feac068848fb0e17359}} 
...
\begin{center}
\leavevmode
\includegraphics[width=306pt]{sqllib_8hpp_a15d37939fd8d5feac068848fb0e17359_cgraph}
\end{center}
\end{figure}
Hier ist ein Graph der zeigt, wo diese Funktion aufgerufen wird\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=550pt]{sqllib_8hpp_a15d37939fd8d5feac068848fb0e17359_icgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_ac79d03d5b5d92da2230f12e6b509ef9d}} 
...
\begin{center}
\leavevmode
\includegraphics[width=280pt]{sqllib_8hpp_ac79d03d5b5d92da2230f12e6b509ef9d_cgraph}
\end{center}
\end{figure}
Hier ist ein Graph der zeigt, wo diese Funktion aufgerufen wird\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=550pt]{sqllib_8hpp_ac79d03d5b5d92da2230f12e6b509ef9d_icgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a966f396dfb5eb84fe35fa86f8c833c98}} 
...
{\footnotesize\ttfamily bool connectionless (\begin{DoxyParamCaption}\item[{const char $\ast$}]{host,  }\item[{const char $\ast$}]{user,  }\item[{const char $\ast$}]{passwort,  }\item[{const char $\ast$}]{db,  }\item[{unsigned int}]{port,  }\item[{const char $\ast$}]{unix\+\_\+socket,  }\item[{unsigned int}]{client\+\_\+flag }\end{DoxyParamCaption})}

\mbox{\label{sqllib_8hpp_a4e62be1037109b753ff7f5a291b5b31c}} 
...
{\footnotesize\ttfamily std\+::string count\+Datasets (\begin{DoxyParamCaption}\item[{std\+::string}]{table\+Name }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a4e62be1037109b753ff7f5a291b5b31c_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a018659fc814b4a097c4b4862f42fe554_cgraph}
\end{center}
\end{figure}
...
Der gesetzte Sekundärschlüssel im Bezug auf den gesetzten Primärschlüssel und die Schlüsselgruppe für den Sekundärschlüssel kann mit dieser Methode gelöscht werden.~\newline
...
void 
\end{DoxyReturn}
\mbox{\label{sqllib_8hpp_a96bdfe7120502a30fdae84c0f6588a7f}} 
...
{\footnotesize\ttfamily std\+::string get\+All\+Column (\begin{DoxyParamCaption}\item[{std\+::string}]{table\+Name }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a96bdfe7120502a30fdae84c0f6588a7f_cgraph}
\end{center}
\end{figure}
...
Ersetzt den Spaltennamen sowie den Datentypen. ~\newline
 Sollte der Fall eintreten, dass der Datentyp nicht geändert wird, kann der Datentyp des Feldes nochmal angegeben werden.~\newline
...
Die Methode \char`\"{}rename\+Database\char`\"{} senden dem Befehl eine Datenbank umzubennen an den S\+QL Server.~\newline
 Bis auf die gewählte Datenbank für die \doxyref{connectionless()}{S.}{connection_8cpp_a4ec2c49f65ab04fdddbdb7e81e6aab18} Methode können alle Datenbanken umbenannt werden.~\newline
...
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a0c0b74ea6569aa25068b80d57061e864}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a0c0b74ea6569aa25068b80d57061e864_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a5497ea7a5b36b35ae8f08ce374790858}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a5497ea7a5b36b35ae8f08ce374790858_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a8c1eb741cc480c74a0042e9689c04a94}} 
\index{sqllib.\+hpp@{sqllib.\+hpp}!select\+Bool@{select\+Bool}}
\index{select\+Bool@{select\+Bool}!sqllib.\+hpp@{sqllib.\+hpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a8c1eb741cc480c74a0042e9689c04a94_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a3eea3cd04977d9873801490d0fbec14a}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a3eea3cd04977d9873801490d0fbec14a_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_aca36da6198b8c35ba721a68a51cd8898}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_aca36da6198b8c35ba721a68a51cd8898_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a118df4625d0eec25ad2215f028520f72}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a118df4625d0eec25ad2215f028520f72_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_ab115e996b276802329fb8d2899c6d44d}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_ab115e996b276802329fb8d2899c6d44d_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_aaad6e80fc6076afccfdccd194889aa92}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_aaad6e80fc6076afccfdccd194889aa92_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a70f6716adfb73ac0b427b3f264b6d848}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a70f6716adfb73ac0b427b3f264b6d848_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a4626b3e4c6a6a456371f2cddc13ffb7a}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a4626b3e4c6a6a456371f2cddc13ffb7a_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a56add7eeed983b8439e87e7814474dff}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a56add7eeed983b8439e87e7814474dff_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a36f7b6465f35b2f96f04c33dec10afa2}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a36f7b6465f35b2f96f04c33dec10afa2_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_ac2063212201f14978b1abb0c9b94a460}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_ac2063212201f14978b1abb0c9b94a460_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a9b72023da3a86c491cef2d340bede35e}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a9b72023da3a86c491cef2d340bede35e_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a4a7a5336f56c689d43717ed65d216928}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a4a7a5336f56c689d43717ed65d216928_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_acf929efd37e4b717717d99807cfe41e2}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_acf929efd37e4b717717d99807cfe41e2_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_aba0d2e1188ed35207922e408c0f366fc}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_aba0d2e1188ed35207922e408c0f366fc_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_ac5d1f449131f10de07406afce2eca45f}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_ac5d1f449131f10de07406afce2eca45f_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a0972bc18453bc3a60f21f0f629fddf52}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a0972bc18453bc3a60f21f0f629fddf52_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a139ed7a657cf0e77c9e30ff75fbf4a49}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a139ed7a657cf0e77c9e30ff75fbf4a49_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a171b9c43b31e26dd2c30acb9344d2da8}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a171b9c43b31e26dd2c30acb9344d2da8_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a8da8323e6a01c3f2ed669dccd7bf2854}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a8da8323e6a01c3f2ed669dccd7bf2854_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_aa6e291bc8aca21c19e88231d4de51b70}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_aa6e291bc8aca21c19e88231d4de51b70_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a1dc6e0b39020c0e1877be2e183e2e049}} 
\index{sqllib.\+hpp@{sqllib.\+hpp}!select\+Union@{select\+Union}}
\index{select\+Union@{select\+Union}!sqllib.\+hpp@{sqllib.\+hpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a1dc6e0b39020c0e1877be2e183e2e049_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a7caa0e0e66c9c4cadc4ec5d596bba565}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a7caa0e0e66c9c4cadc4ec5d596bba565_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_ade3cc06b3d1ac3dc344ec9f606290468}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_ade3cc06b3d1ac3dc344ec9f606290468_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a1985a11967a7cbb2a2b38416fc6ffad5}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a1985a11967a7cbb2a2b38416fc6ffad5_cgraph}
\end{center}
\end{figure}
...
table\+Name\+Primary und primary\+Key verbinden den Primärschlüssel aus einer Tabelle mit einer gewünschten Spalte und setzt den Foreign\+Key auf diese.~\newline
 So können die Abhängigkeiten vom Primärschlüssel im Bezug auf einer anderen Tabelle gelöst werden. ~\newline
 Zusätzlich kann durch die Angabe des Übergabeparameters constraint eine Schlüsselgruppe definiert werden.~\newline
...
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a8427554ae56596f846166ee15a18ca9a}} 
...
{\footnotesize\ttfamily std\+::string show\+Column\+Typ (\begin{DoxyParamCaption}\item[{std\+::string}]{table\+Name,  }\item[{std\+::string}]{datatype }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a8427554ae56596f846166ee15a18ca9a_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_a7a817804965bb8abfbeaee58fff003d7}} 
...
{\footnotesize\ttfamily std\+::string show\+Databases (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_a7a817804965bb8abfbeaee58fff003d7_cgraph}
\end{center}
\end{figure}
\mbox{\label{sqllib_8hpp_aef6c147be23808daed1acc7ca2dd5e7c}} 
...
{\footnotesize\ttfamily std\+::string show\+Table (\begin{DoxyParamCaption}\item[{std\+::string}]{table\+Name }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sqllib_8hpp_aef6c147be23808daed1acc7ca2dd5e7c_cgraph}
\end{center}
\end{figure}
