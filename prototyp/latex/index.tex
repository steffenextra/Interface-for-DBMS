...
Durch vorgefertigte Präprozessor-\/\+Direktiven wird für Mac\+O\+S-\// sowie Linuxbetriebssysteme der zu benötigende My\+S\+Q\+L-\/\+Header beim kompilieren direkt rausgesucht. ~\newline
 ...
 Sollte dies nicht der Fall sein, muss die Variable in der \doxyref{connectionless()}{S.}{connection_8cpp_adda241635377573037e48ec03e645c22} Methode gelöscht und durch eine eigene Variable (String des Pfads + mysql.\+h) ersetzt werden.~\newline
...
Da in diesem Projekt ausschließlich mit der My\+S\+Q\+L-\/\+Standardbibliothek gearbeitet wurde, passiert die Fehlerausgabe über die \doxyref{check\+\_\+error()}{S.}{connection_8cpp_a33fd832a9e1a27bddb7d9837a2dcf2f1} Methode.~\newline
